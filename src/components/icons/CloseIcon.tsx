import {IconProps} from "../types.ts";
 ...
 const CloseIcon = ({color, size, width, height, fill}: IconProps) => {
     return <svg viewBox="0 0 1024 1024" fill={fill || 'none'} width={size ?? width} height={size ?? height}  xmlns="http://www.w3.org/2000/svg" >
