...
const DownloadIcon = ({color, size, width, height, fill}: IconProps) => {
    return <svg viewBox="0 0 24 24" fill={fill || 'none'} width={size ?? width} height={size ?? height}  xmlns="http://www.w3.org/2000/svg">
