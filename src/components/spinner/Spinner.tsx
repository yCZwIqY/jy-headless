...
const Spinner: React.FC<SpinnerProps> = ({color, size, spinTime}) => {
    return <>
        ...
        <svg viewBox="0 0 20 20"
             ...
             width={size || '30px'} height={size || '30px'}
             xmlns:xlink="http://www.w3.org/1999/xlink" fill={color || 'black'}>
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <g id="🔍-System-Icons" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id="ic_fluent_spinner_ios_20_filled" fill="#212121" fillRule="nonzero">
                    <path
